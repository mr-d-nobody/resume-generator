      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-1 space-y-8">
          <section>
            ...
            <ContactLinks 
              personal={personal} 
              containerClass="text-sm space-y-2 text-gray-600 bg-white p-5 rounded-lg shadow-sm border border-gray-100"
              itemClass="block"
            ...
            <section>
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 flex flex-wrap gap-2">
                {Object.values(skills).flat().map((skill, idx) => (
                  <span key={`${skill}-${idx}`} className="px-3 py-1 bg-gray-800 text-white text-xs font-medium rounded-full">
                    {skill}
                  </span>
                ))}
              </div>
