          ...
          <div>
            ...
            <Link
              to={destination('/templates')}
                className="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-blue-200 hover:text-blue-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-200"
            >
              View Templates
            </Link>
          </div>
